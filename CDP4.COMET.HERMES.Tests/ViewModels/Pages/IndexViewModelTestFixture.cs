...
namespace CDP4.COMET.HERMES.Tests.ViewModels.Pages
{
    ...
    public class IndexViewModelTestFixture
    {
        ...
        public void Setup()
        {
            ...
            this.viewModel = new IndexViewModel(this.versionService.Object);
        }

        [Test]
        public void VerifyProperties()
        {
            Assert.That(this.viewModel.VersionService, Is.Not.Null);
        }
    }
}